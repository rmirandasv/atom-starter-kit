    ...
    <div className="flex flex-col gap-4">
      {!auth.user.two_factor_confirmed_at && (
        <div className="flex flex-col gap-2">
          {!qrCode && (
            <Fragment>
              <Button onClick={handleEnableTwoFactor} className="w-fit" disabled={loading}>
                {loading ? "Enabling..." : "Enable two-factor authentication"}
              </Button>
              <p className="text-sm text-muted-foreground">
                Two-factor authentication adds an extra layer of security to your account by requiring a verification code in addition to your
                password. This code is typically generated by an authentication app on your phone, such as Google Authenticator or Authy.
              </p>
            </Fragment>
          )}
          {qrCode && (
            <div className="flex flex-col gap-2">
              <p className="text-sm text-green-600">
                Two-factor authentication is enabled. Scan the QR code below with your authentication app to set it up.
              </p>
              <div className="shadow-s w-fit rounded-md bg-white p-4" dangerouslySetInnerHTML={{ __html: qrCode }} />
              <Form {...form}>
                <form onSubmit={form.handleSubmit(handlCompleteTwoFactor)}>
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    Enter the verification code generated by your authentication app to confirm two-factor authentication.
                  </p>
                </form>
              </Form>
            </div>
      ...
      {auth.user.two_factor_confirmed_at && (
        <div className="flex flex-col gap-2">
          <p className="text-sm font-medium text-green-600">Two-factor authentication is enabled. You can disable it at any time.</p>
          <p className="text-sm text-muted-foreground">
            If you lose access to your authentication app, you may be locked out of your account. Make sure to save your backup codes in a safe place.
          </p>
          <div className="flex flex-col gap-2 md:flex-row">
            <Button onClick={handleDownloadRecoveryCodes} disabled={downloading}>
              {downloading ? "Downloading..." : "Download recovery codes"}
            </Button>
            <Button onClick={handleDisableTwoFactor} variant="destructive" disabled={loading}>
