import { VerticalMenu, VerticalMenuList, VerticalMenuListItem } from "@/components/ui/vertical-menu";
    ...
    <VerticalMenu>
      <VerticalMenuList>
        <VerticalMenuListItem active={route().current("settings.profile")}>
          <Link href={route("settings.profile")} prefetch>
            Profile
          </Link>
        </VerticalMenuListItem>
        <VerticalMenuListItem active={route().current("settings.password")}>
          <Link href={route("settings.password")} prefetch>
            Password
          </Link>
        </VerticalMenuListItem>
